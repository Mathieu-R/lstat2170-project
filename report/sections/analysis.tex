...
In order to have a clearer view of these elements, we can decompose the time series by performing a \textbf{classical decomposition}. %This method assume that the seasonal component repeat from year to year which is kind of a reasonable assumption for air temperature data.  
